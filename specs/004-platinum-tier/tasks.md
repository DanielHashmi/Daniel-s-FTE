...
- [ ] T001 Create deployment/cloud directory structure per plan
- [ ] T002 Create deployment/local directory structure per plan
- [ ] T003 Add ecosystem.config.js for PM2 in deployment/cloud/ecosystem.config.js
- [ ] T004 Create .env.example with ODOO/SYNCTHING vars

## Phase 2: Foundational Infrastructure (8 tasks)
- [ ] T005 Deploy Odoo Docker in deployment/cloud/docker-compose.odoo.yml
